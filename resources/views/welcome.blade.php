...
<body class="bg-red-500 min-h-screen flex items-center justify-center">
    <div class="max-w-4xl bg-zinc-100 text-white p-8 rounded-lg shadow-lg flex flex-col md:flex-row items-center">
        ...
        <div class="md:w-1/2 space-y-4">
            <a
                                        href="{{ route('login') }}"
                                        class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-[#EF4444] focus:outline-none focus-visible:ring-[#FF2D20] dark:text-dark dark:hover:text-dark/80 dark:focus-visible:ring-white"
                                        >
                                        Acceder
                                    </a>
